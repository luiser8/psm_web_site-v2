    ...
    <>
      {eventosData.active ? (
        <section className="w-full h-full mt-5 xl:mt-16">
          ...
          <div className="w-[100%] h-full flex justify-center items-center gap-y-6 flex-col p-2 xl:p-0 rounded-lg mx-auto xl:flex-row md:gap-x-24">
            <div className="mb-5 h-[70vh] w-full xl:h-full xl:w-1/2 overflow-hidden">
              <img
                src={eventPrincipal.image}
                alt="eventos"
                className=" mx-auto w-full h-full object-fill object-center bg-black"
              />
            </div>
