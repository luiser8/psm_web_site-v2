  ...
  data: [
    {
      ...
      paragraph4:
        "Asimismo investiga y propone obras de recuperación, renovación, rehabilitación y refuncionalización de edificios y de otros espacios.",
      paragraph5:
        "Sus capacidades e incumbencias profesionales lo habilitan también para efectuar la planificación arquitectónica y urbanística, en todas sus etapas y escalas, de los espacios destinados a los asentamientos urbanos.",
      full_description: "",
      more: {
        graduate_profile:
    ...
    },
    {
      ...
      paragraph2:
        "Su objeto es la realización de actividades referentes al Planeamiento y Proyecto de regiones, zonas, ciudades, en lo concerniente a sus construcciones, sus servicios, sus transportes y sus recursos hídricos.",
      paragraph3:
        "El profesional egresado de esta carrera será capaz de proyectar, diseñar, planear, construir y gestionar obras y sistemas de ingeniería civil, como edificios, estructuras, carreteras, puentes, túneles, canales, represas, pistas y terminales de aeropuertos, obras portuarias, conjuntos habitacionales y centros educacionales, sistemas de abastecimiento de agua y de eliminación de desechos, centros comerciales y edificios para oficinas, clínicas y hospitales; centrales telefónicas y eléctricas; centros de recreación y desarrollo turístico;",
      paragraph4:
        "obras de urbanización, sistemas de transporte colectivo y otros componentes destinados a satisfacer necesidades de la sociedad y a mejorar la calidad de vida de los grupos humanos.",
      paragraph5: "",
      full_description: "",
      more: {
        graduate_profile:
    ...
    },
    {
      ...
      paragraph2:
        "El Ingeniero Electricista es un profesional con una fuerte formación sobre los Sistemas Energéticos.",
      paragraph3:
        "Esta carrera capacita para el trabajo con los medios electrotécnicos y sistemas empleados en la generación, transmisión, distribución y utilización de la energía eléctrica, especialmente en tareas de proyecto, montaje, mantenimiento y explotación, tanto en los sistemas de suministro eléctrico como en el equipamiento de las instalaciones industriales.",
      paragraph4:
        "La disciplina también está relacionada con los dispositivos componentes de los sistemas mencionados: transistores, circuitos integrados, antenas, dispositivos de memoria.",
      paragraph5:
    ...
    },
    {
      ...
      paragraph2:
        "El progreso y calidad de vida de las personas y las sociedades están vinculados al desarrollo de la tecnología.",
      paragraph3:
        "A su vez, el avance de la tecnología depende del desarrollo de la ingeniería electrónica que hace posible la continua expansión de las fronteras de la tecnología hacia nuevos horizontes.",
      paragraph4:
        "La ingeniería electrónica se entiende como una profesión que, a través del diseño y la integración de hardware y software, crea nuevos productos y soluciones tecnológicas que hacen más fácil, variada y confortable la vida de las personas.",
      paragraph5:
        "Los ingenieros electrónicos lideran la revolución tecnológica en los campos de las telecomunicaciones, la automatización industrial y de servicios, la bioingeniería, la robótica, la inteligencia artificial, la información multimedia y la optoelectrónica.",
      full_description: "",
      more: {
        graduate_profile:
    ...
    },
    {
      ...
      paragraph3:
        "La Ingeniería Industrial constituye una disciplina de múltiples áreas, las cuales representan posibilidades de especialización y desempeño para los profesionales de la misma.",
      paragraph4:
        "Las grandes corporaciones y empresas del Estado, las empresas del sector productivo privado, las zonas francas industriales y los sectores comercial y financiero constituyen la plataforma natural de trabajo para los egresados de esta carrera.",
      paragraph5: "",
      full_description: "",
      more: {
        graduate_profile:
    ...
    },
    {
      ...
      paragraph3:
        "En toda la carrera los estudiantes están en contacto directo con lo que será su campo de trabajo, a través de visitas a empresa, prácticas profesionales, conferencias dictadas por altos ejecutivos conocidos en el campo empresarial.",
      paragraph4:
        "Nuestros alumnos cuentan con todos los laboratorios indispensables para la mejor formación académica.",
      paragraph5: "",
      full_description: "",
      more: {
        graduate_profile:
    ...
    },
    {
      ...
      paragraph4:
        "La Ingeniería de Sistemas es la aplicación de esfuerzos científicos y de ingeniería para transformar una necesidad de operación en una descripción de parámetros de rendimiento del sistema y una configuración del sistema a través del uso de un proceso iterativo de definición, síntesis, análisis, diseño, prueba y evaluación; integrar parámetros técnicos relacionados para asegurar la compatibilidad de todas las interfaces de programa y funcionales de manera que optimice la definición y diseño del sistema total;",
      paragraph5:
    ...
    },
    {
      ...
      paragraph2:
        "La carrera de Agronomía está orientada a formar profesionales capaces de enfrentar y resolver los problemas que presentan los procesos productivos y de transformación en el agro, con una adecuada protección del medio ambiente y de los recursos naturales.",
      paragraph3:
        "Los estudios de la carrera de Agronomía se orientan a entregar al estudiante una formación profesional en el área agrícola, manejando recursos agrarios, animales y vegetales.",
      paragraph4:
        "El Ingeniero Agrónomo está capacitado para elaborar proyectos, evaluar y asesorar en todo lo referido a producción agropecuaria, conservación y recuperación de los recursos naturales.",
      paragraph5:
        "Dirigir, organizar y asesorar explotaciones agrícolas y ganaderas. Controlar calidad y tipificar productos frescos o para uso industrial. Ejercer la docencia y la investigación.",
      full_description: "",
      more: {
        graduate_profile:
          "El Arquitecto egresado del PSM se ocupa de organizar espacios habitacionales en función del hombre, a través de estudios y proyectos de edificación, coordinando sus diversas etapas de planificación, diseño y construcción. Orienta y coordina las funciones de los trabajadores a sus órdenes. Analiza los proyectos para determinar los estilos y tipos de construcción. Hace estudios urbanísticos de distintas zonas.",
