export default {
  ...
  eventos: {
    active: true, eventos_data: [
      {
        id: 1,
        image: "/images/extensionMaracay/events/event_details.jpg",
  ...
  carreras: {
    active: true, carreras_data: [
      ...
      },
      {
        ...
        image: "/images/extensionMaracay/carreras/diseno.jpg",
        detail: "diseno",
        path: "/maracay",
        description: "",
        paragraph1:
  ...
  noticias: {
    active: true, path: "/maracay/noticias", noticias_data: [
      {
        id: 1,
        principal: true,
